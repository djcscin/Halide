...
cd bin && ^
cmake -G Ninja -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=%VCPKG_CMAKE_FILE% \
-DHalide_DIR=%HALIDE_ROOT%\lib\cmake\Halide -DHalideHelpers_DIR=%HALIDE_ROOT%\lib\cmake\HalideHelpers .. && ^
cmake --build . && cd .. && ^
